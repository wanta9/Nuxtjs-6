...
<template>
  <section class="flex justify-center py-10 mt-28">
    <div class="w-[500px]">
      ...
      <form @submit.prevent="submitCategory">
        ...
        <button
          type="submit"
          class="border border-5 focus:ring-4 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
        >
          Submit
        </button>
      </form>
